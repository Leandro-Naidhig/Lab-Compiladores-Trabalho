...
void _A_m1(_class_A *self, int _n) {
   (self->_A_k) = 1;
   printf("%s", (concatStrings((concatStrings((concatStrings(intToString((self->_A_k)), " ")), intToString(_n))), " ")));
}
...
void _B_m2(_class_B *self, int _n) {
   ...
   printf("%s", (concatStrings((concatStrings((concatStrings(intToString((self->_B_k)), " ")), intToString(_n))), " ")));
}
...
void _C_m3(_class_C *self, int _n) {
   ...
   printf("%s", (concatStrings((concatStrings("3 ", intToString(_n))), " ")));
}
void _C_m4(_class_C *self, int _n) {
   (self->vt[3])(self, 3);
   printf("%s%s", (concatStrings("4 ", intToString(_n))), " ");
}
