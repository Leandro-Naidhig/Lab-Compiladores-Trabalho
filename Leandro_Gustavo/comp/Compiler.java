					...
					if(lexer.token == Token.ID) {
						...
						if(lexer.token == Token.DOT) {
							...
							if(lexer.token == Token.ID) {
								...
								return new SelfExpr(membro1, membro2, exprList, currentClass);			
						...
						return new SelfExpr(membro1, null, null, currentClass);
						...
						return new SelfExpr(membro1, null, exprList, currentClass);

					} else {
						error("An identifier or identifer: was expected after '.'");
					}
				} else {
					return new SelfExpr(null, null, null, currentClass);
				}
				break;
			default:
				break;
